...
.text
    ...
    31:    LB     r8,  30(r4)     ;leggi frase[i]
        DSUB      r11, r6,   r2   ;'[' - chiave
        SLT       r9,  r8,   r6   ;frase[i] < '[' ?
        SLT       r10, r7,   r8   ;'@' < frase[i] ?
        AND       r9,  r9,   r10  ;AND tra i due esiti precedenti
        SLT       r11, r8,   r11  ;frase[i] < ('[' - chiave) ?
        BNEZ      r9,  sem31      ;if1: salta se diverso da zero

        SB        r8,  30(r5)     ;else1: frasecifrata[i] = frase[i]
        J         endif31         ;salto incondizionato
    
    ;entro in if1
    sem31:  BNEZ   r11, set31     ;if2: salta se diverso da zero
        ...
        DSUB      r16, r16,  r15  ;r16 - 'Z' in r16
        DADDI     r16, r16,  -1   ;decremento r16
        SB        r16, 30(r5)     ;frasecifrata[i] = r16
        J         endif31         ;salto incondizionato

    ;entro in if2
    set31:  DADD   r20, r8,   r2  ;frase[i] + chiave
        SB        r20, 30(r5)     ;frasecifrata[i] = r20
